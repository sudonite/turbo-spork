...
// Last edited date : Wed, 03 Aug 2022 11:08:58 +0000
// --------------------------------------------------------------------------------

$l['nav_newthread'] = 'Post Thread';
$l['newthread_in'] = 'Post Thread in {1}';
$l['post_new_thread'] = 'Post Thread';
$l['thread_subject'] = 'Title <span class="text-danger" style="font-size: 10px; font-weight: 700">REQUIRED</span>';
$l['your_message'] = 'Message <span class="text-danger" style="font-size: 10px; font-weight: 700">REQUIRED</span>';
