...
// Last edited date : Fri, 05 Aug 2022 02:08:22 +0000
// --------------------------------------------------------------------------------

$l['nav_usercp'] = 'Account Settings';
...
$l['edit_sig_note2'] = 'Max. length is {5} characters.';
...
$l['enable_sig_posts'] = 'Enable signature in all existing posts.';
$l['disable_sig_posts'] = 'Disable signature in all existing posts.';
$l['leave_sig_settings'] = 'No action.';
$l['update_sig'] = 'Update';
$l['preview'] = 'Preview';
$l['current_sig'] = 'Current Signature';
...
$l['allow_notices'] = 'Receive emails from administrators.';
...
$l['contact_field_google'] = 'Google ID';
...
$l['no_thread_subscriptions'] = 'You\'re currently not subscribed to any threads.<br /><br /><p>To subscribe to a thread:</p><ol><li>Navigate to the thread you wish to subscribe to.</li><li>Click the \'Subscribe to this thread\' link towards the bottom of the page.</li></ol>';
...
$l['no_drafts'] = 'You do not currently have any draft threads or posts.<br /><br /><div class="ps-3 pe-3">To save a draft thread or post:<br /><br /><ol><li>Proceed to the normal posting pages for the action you wish to perform (post a new thread or reply to an existing one).</li><li>Fill in as much or as little as you want on the posting page.</li><li>Click the \'Save as Draft\' button below the posting area.</li></ol></div>';
$l['drafts'] = 'Saved Drafts';
$l['drafts_count'] = 'Saved Drafts ({1})';
$l['draft_saved'] = 'Saved';
$l['edit_draft'] = 'Edit';
$l['draft_title'] = 'Draft Title';
$l['delete_drafts'] = 'Delete Selected';
...
$l['usergroups_memberof'] = 'Group Memberships';
...
$l['avatar_note'] = 'An avatar is a small identifying image shown under the author\'s name whenever they make a post. <br />';
$l['avatar_note_dimensions'] = 'Max dimensions {1}x{2} pixels.';
$l['avatar_note_size'] = 'Max file size {1}.';
$l['custom_avatar'] = 'Custom Avatar';
$l['remove_avatar'] = 'Remove Avatar';
$l['attachments_manager'] = 'Attachments';
...
$l['attachstats_bandwidth'] = 'Bandwidth Usage';
...
$l['new_custom_usertitle'] = 'New Title (leave blank to use existing)';
...
$l['default_usertitle'] = 'Default';
$l['current_custom_usertitle'] = 'Current';
...
$l['referral_link'] = '<label for="referurl" class="text-muted">Referral (copy & paste)</label><input type="text" id="referurl" class="form-control border text-success" value="{1}/member.php?action=register&amp;referrer={2}"></input>';
...
$l['subscription_method'] = 'Subscription';
...
$l['buddyrequests_auto'] = 'Automatically accept buddy requests?';
